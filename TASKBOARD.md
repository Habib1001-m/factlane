...
```text
ACTIVE_SPEC=NONE_BOUNDED_DOCUMENTATION_RECONCILIATION
ACTIVE_PLAN=NONE_BOUNDED_DOCUMENTATION_RECONCILIATION
CURRENT_SLICE=DOCUMENTATION_TRUTH_RECONCILIATION
